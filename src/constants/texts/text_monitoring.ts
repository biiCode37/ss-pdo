...
export const TEXT_MONITORING = {
  HEADER: {
    ...
    SUBTITLE: "Ringkasan 18 Rute & Rekapitulasi Harian",
    ...
    BTN_SYNC_GLOBAL_TITLE:
      "Tarik Data 18 Rute dari Spreadsheet Capaian Global Wilayah",
  ...
  SYNC_MODAL: {
    ...
    SUCCESS_DESC: (count: number) =>
      `Berhasil menyinkronkan ${count} rute ke database.`,
  ...
  BULK_VERIFY: {
    ...
    NO_ROUTES_TO_VERIFY:
      "Tidak ada rute berstatus submitted yang siap diverifikasi.",
  },
  DASHBOARD: {
    PROGRESS_TITLE: "Status Armada Rute",
    ...
    CHART_TITLE: "Grafik Jumlah Pelanggan Per Rute",
    CHART_SUBTITLE: (dateStr?: string) =>
      dateStr
        ? `Komparasi total pelanggan pada hari ${dateStr}`
        : "Komparasi total pelanggan dari 18 rute hari ini",
    ...
    MACRO_KPIS: {
      ...
      PER_BUS: "per Bus",
      PER_KM: "per KM",
      PASSENGERS_SUFFIX: "Org",
      TRIPS_SUFFIX: "Rit",
      DISTANCE_SUFFIX: "KM",
      PRODUCTIVITY_SUFFIX: "Org/Bus",
      SUBTEXT_PER_KM: (val: string | number) => `${val} Org per KM`,
    },
    SHIFT_SPLIT: {
      TITLE: "Komparasi Pelanggan Antar Shift",
      SHIFT_1: "Shift 1",
      SHIFT_2: "Shift 2",
      UNIT_LABEL: "Org",
    ...
    LEADERBOARD: {
      ...
      TARGET_PCT_ONLY: (pct: string) => `${pct}%`,
    },
  },
  FLEET_TAB: {
    ...
    EMPTY_DESC:
      "Luar biasa! Seluruh armada 18 rute berstatus SGO (Siap Guna Operasi) tanpa kendala.",
  ...
  INGESTION: {
    ...
    MODAL_SUBTITLE:
      "Menarik ringkasan capaian langsung dari Google Sheets rute",
