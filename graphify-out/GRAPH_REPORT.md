...
Cohesion: 0.10
Nodes (21): ProfileAdminSection(), ProfileAdminSectionProps, ProfileFeaturesSection(), ProfileFeaturesSectionProps, ProfileMenuFooter(), ProfileMenuFooterProps, ProfileMenuSheet(), ProfileUserCard() (+13 more)
...
Cohesion: 0.11
Nodes (27): Props, renderStatusBadge(), UnitCard, UnitCardComponent(), Props, UnitDetailModal(), Props, UnitSummaryDashboard (+19 more)
...
Cohesion: 0.24
Nodes (11): RouteSelectorSheet(), RouteSelectorSheetProps, useMobileBackHandler(), UseMobileBackHandlerOptions, BackNavigationEntry, handlePopState(), initHistoryNavigation(), isRunningStandalone() (+3 more)
...
Cohesion: 0.37
Nodes (14): getGapi(), getGoogleCreds(), getTokenClient(), hasGoogleCreds(), initGoogleApi(), setTokenClient(), signIn(), checkSignedInAsync() (+6 more)
...
### Community 263 - "types/supabase.ts"
Cohesion: 0.08
Nodes (42): calculateRegionalTotals(), fetchRegionalMonitoringData(), getRelativeDate(), parseDateParts(), RegionalMonitoringResult, SUPERVISORS, syncRegionalDailyFromGlobalSheet(), fetchDailyRouteReport() (+34 more)
...
Cohesion: 0.10
Nodes (14): BottomNav, BottomNavProps, mockSignIn, mockSignOut, mockUpsertUserProfile, mockVerifyUserProfile, AddRouteModalProps, TEXT_ALERTS (+6 more)
...
Cohesion: 0.21
Nodes (11): App(), LoginScreen(), LoginScreenProps, TestComponent(), useUserActivityTracking(), signOut(), AuthResult, sendUserHeartbeat() (+3 more)
...
Cohesion: 0.12
Nodes (27): logActivity(), readPendingActivityLogs(), writePendingActivityLogs(), createRouteWithSheet(), deleteRouteSheet(), fetchRoutesWithSheets(), upsertDailyUnitSummaries(), flushPendingLocalSync() (+19 more)
...
Cohesion: 0.28
Nodes (9): LegalModals(), LegalModalsProps, LegalModalType, LoginFeatureCards(), LoginFooter(), LoginFooterProps, LoginHeroCard(), LoginHeroCardProps (+1 more)
...
Cohesion: 0.12
Nodes (26): AnalyticsDashboard, AnalyticsDashboardComponent(), Props, Props, KPICard, KPICardComponent(), Props, Props (+18 more)
...
Cohesion: 0.10
Nodes (24): BusInputModal(), BusInputModalProps, BusInputModalFooter(), BusInputModalFooterProps, BusInputModalHeader(), BusInputModalHeaderProps, BusInputModalNotes(), BusInputModalNotesProps (+16 more)
...
### Community 338 - "react"
Cohesion: 0.11
Nodes (13): react, mockData, mockRoutes, mockFleetShifts, mockRouteItems, mockData, SwipeableContainer(), SwipeableContainerProps (+5 more)
...
### Community 341 - "busCard/BusCard.tsx"
Cohesion: 0.12
...
### Community 351 - "core.ts"
Cohesion: 0.11
Nodes (39): getAccumulatedBusData(), getMonthlyToaTrend(), inspectSpreadsheetHeader(), monthlyToaTrendCache, withAuthRetry(), detectHeaderRowAndBuildComposite(), extractSheetId(), findColumnIndex() (+31 more)
...
### Community 353 - "useOfflineSync.ts"
Cohesion: 0.16
Nodes (21): TestHookComponent(), detectCollision(), readQueueFromStorage(), useOfflineSync(), writeQueueToStorage(), getBusRowData(), updateBusData(), backupSyncQueue() (+13 more)
...
Cohesion: 0.16
Nodes (23): findOperator(), formatOperatorFull(), formatOperatorsDisplay(), getAllActiveOperators(), getOperatorOfficialName(), isValidOperatorCode(), MASTER_OPERATORS, OperatorItem (+15 more)
...
Cohesion: 0.08
Nodes (24): AllRouteMonitoringPage, AllRouteMonitoringPageProps, mockData, IngestionProgressModal(), IngestionProgressModalProps, MonitoringBottomNav, MonitoringBottomNavProps, MonitoringTab (+16 more)
...
## Knowledge Gaps
- **2274 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+2269 more)
...
- **Why does `react` connect `react` to `plugins`, `profileMenu/ProfileMenuSheet.tsx`, `monitoring/index.ts`, `texts/index.ts`, `Dashboard.tsx`, `dailyToaTrend/DailyToaTrendCard.tsx`, `App.tsx`, `routeSelector/RouteSelectorCard.tsx`, `login/LoginScreen.tsx`, `LoginInfoModal.tsx`, `utils/analytics.ts`, `busList/BusList.tsx`, `BusInputModal.tsx`, `Skeletons.tsx`, `busCard/BusCard.tsx`, `usePreviousDayOdometer.ts`, `waReport/WaReportModal.tsx`, `useOfflineSync.ts`, `dashboard/QueueModal.tsx`, `MonitoringDashboardTab.tsx`, `keteranganUtils.ts`, `monitoring/AllRouteMonitoringPage.tsx`, `BusData`, `ShiftConfirmationAlertBar.tsx`, `accumulation/AccumulationSheet.tsx`, `userManagement/UserManagementPage.tsx`, `FleetStatusModal.tsx`, `pdoReport/RouteOperationalReportCard.tsx`, `historyNavigation.ts`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `supabase` connect `types/supabase.ts` to `routes.ts`, `appSettingsService.ts`, `core.ts`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `BusData` connect `BusData` to `useOfflineSync.ts`, `utils/analytics.ts`, `FleetStatusModal.tsx`, `routes.ts`, `core.ts`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
