...
## Corpus Check
- 326 files · ~339,918 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2766 nodes · 3787 edges · 241 communities (215 shown, 26 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `78cadc6d`
...
## Communities (241 total, 26 thin omitted)
...
### Community 6 - "UserManagementPage.tsx"
Cohesion: 0.21
Nodes (17): FilterTab, UserManagementPage(), UserManagementPageProps, logActivity(), readPendingActivityLogs(), writePendingActivityLogs(), flushPendingLocalSync(), addUserProfile() (+9 more)
...
Cohesion: 0.20
Nodes (23): BusListComponent(), ProfileMenuSheet(), Props, QueueModal(), QueueModalProps, BulkCopyKmModalOptions, getCurrentTheme(), pdoSwal (+15 more)
...
Cohesion: 0.19
Nodes (17): Props, renderStatusBadge(), UnitCard, UnitCardComponent(), UnitDetailModal(), UnitSummaryDashboardComponent(), slugifyUnitId(), calculateUnitMetrics() (+9 more)
...
Cohesion: 0.11
Nodes (26): AnalyticsDashboard, AnalyticsDashboardComponent(), Props, CompletionStatusCard, Props, DailyToaTrendCard, DailyToaTrendCardComponent(), parseSelectedDay() (+18 more)

### Community 121 - "Dashboard.tsx"
Cohesion: 0.14
Nodes (16): BusList, Dashboard(), Props, UserManagementPage, BusCardSkeleton(), DailyToaTrendSkeleton(), SkeletonBox(), SkeletonBoxProps (+8 more)
...
Cohesion: 0.27
Nodes (14): escapeHtml(), MAX_SHIFT_DISTANCE_KM, MAX_TOA_VALUE, MAX_TRIP_COUNT, renderSatsetToggle(), renderSmartKeteranganSection(), setupSmartKeteranganLogic(), showBusInputModal() (+6 more)

### Community 125 - "react"
Cohesion: 0.16
Nodes (10): react, ShiftConfirmationAlertBar, ShiftConfirmationAlertBarProps, RoleBadge(), RoleBadgeProps, SwipeableContainer(), SwipeableContainerProps, TestComponent() (+2 more)
...
### Community 140 - "auth.ts"
Cohesion: 0.27
Nodes (15): App(), LoginScreen(), checkSignedInAsync(), ensureValidToken(), fetchGoogleUserProfile(), getGapi(), getGoogleCreds(), hasGoogleCreds() (+7 more)
...
Cohesion: 0.16
Nodes (19): Props, Props, Props, Props, TestHookComponent(), detectCollision(), readQueueFromStorage(), SyncItem (+11 more)

### Community 218 - "core.ts"
Cohesion: 0.06
Nodes (74): AccumulationSheet(), Props, Props, RouteSelectorCard, RouteSelectorCardComponent(), getAccumulatedBusData(), getMonthlyToaTrend(), inspectSpreadsheetHeader() (+66 more)
...
Cohesion: 0.25
Nodes (7): BusCard, BusCardComponent(), showErrorToast(), EDITABLE_BUS_FIELDS, mergeRemoteBusDataWithLocalUpdates(), formatUserError(), getSatsetMode()
...
### Community 240 - "Anti-patterns to avoid"
Cohesion: 0.67
Nodes (3): Anti-patterns to avoid, Avoid offering too many options, Avoid Windows-style paths

## Knowledge Gaps
- **1572 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+1567 more)
...
- **Why does `react` connect `react` to `texts/index.ts`, `AllRouteMonitoringPage.tsx`, `plugins`, `BusData`, `UserManagementPage.tsx`, `keteranganUtils.ts`, `auth.ts`, `alertUtils.ts`, `useMobileBackHandler`, `googleSheets.ts`, `utils/analytics.ts`, `Dashboard.tsx`, `core.ts`, `TEXT_DASHBOARD`, `BusCard.tsx`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `BusData` connect `BusData` to `keteranganUtils.ts`, `alertUtils.ts`, `googleSheets.ts`, `utils/analytics.ts`, `Dashboard.tsx`, `core.ts`, `busInputModal.ts`, `BusCard.tsx`?**
