...
## Corpus Check
- 510 files · ~394,967 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3584 nodes · 4605 edges · 312 communities (285 shown, 27 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d11a79bd`
...
- `BulkTripModalOptions` --references--> `HeaderMap`  [EXTRACTED]
  src/utils/alertUtils.ts → src/services/googleSheets/types.ts
...
## Communities (312 total, 27 thin omitted)
...
Cohesion: 0.19
Nodes (18): FormattedNoteText(), getTabGid(), numberToColumnName(), formatWholeSheet(), updateBulkBusData(), HeaderMap, MonthlyToaTrendItem, SpreadsheetInspectionResult (+10 more)
...
Cohesion: 0.10
Nodes (48): QueueModal(), QueueModalProps, SyncItem, BulkCopyKmModalOptions, BulkTripModalOptions, getCurrentTheme(), pdoSwal, pdoToast (+40 more)
...
Cohesion: 0.05
Nodes (53): AllRouteMonitoringPage, mockData, FormatType, SupervisorFilter, WaReportModalProps, useWaReportData(), UseWaReportDataOptions, WaReportFormatTabs() (+45 more)
...
Cohesion: 0.11
Nodes (10): BottomNav, BottomNavProps, ShiftConfirmationAlertBar, ShiftConfirmationAlertBarProps, TEXT_ALERTS, TEXT_ERRORS, TEXT_FLEET_STATUS, TEXT_MONITORING (+2 more)
...
### Community 278 - "react"
Cohesion: 0.31
Nodes (6): react, RoleBadge(), RoleBadgeProps, SwipeableContainer(), SwipeableContainerProps, UserRole
...
Cohesion: 0.06
Nodes (33): BusCard, BusCardComponent(), BusCardStyleOptions, getBusCardStyles(), BusCardSummary(), BusCardSummaryProps, BusCardProps, useBusCardModal() (+25 more)
...
### Community 285 - "useDashboardUiState.ts"
Cohesion: 0.26
Nodes (8): TestHookComponent(), useDashboardSyncHandlers(), UseDashboardSyncHandlersOptions, DashboardMainTab, DashboardView, TestHookComponent(), useDashboardUiState(), UseDashboardUiStateOptions
...
Cohesion: 0.12
Nodes (27): extractSheetId(), DailyUnitSummary, FleetStatusLog, Operator, Route, RouteSheet, SyncQueueBackup, extractMonthYearLabel() (+19 more)
...
## Knowledge Gaps
- **1899 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+1894 more)
...
- **Why does `react` connect `react` to `waReportGenerator.ts`, `plugins`, `ProfileMenuSheet.tsx`, `texts/index.ts`, `Dashboard.tsx`, `DailyToaTrendCard.tsx`, `utils/analytics.ts`, `App.tsx`, `useOfflineSync.ts`, `BusList.tsx`, `RouteSelectorCard.tsx`, `UserProfileHeader.tsx`, `useDashboardUiState.ts`, `LoginInfoModal.tsx`, `alertUtils.ts`, `AllRouteMonitoringPage.tsx`, `LoginScreen.tsx`, `AccumulationSheet.tsx`, `UserManagementPage.tsx`, `FleetStatusModal.tsx`, `BusData`, `RouteOperationalReportCard.tsx`, `historyNavigation.ts`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `BusData` connect `BusData` to `useOfflineSync.ts`, `routes.ts`, `mutations.ts`, `utils/analytics.ts`, `FleetStatusModal.tsx`, `BusList.tsx`, `alertUtils.ts`, `core.ts`?**
