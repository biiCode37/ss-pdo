...
## Corpus Check
- 458 files · ~383,960 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3404 nodes · 4425 edges · 300 communities (272 shown, 28 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `db52df00`
...
Cohesion: 0.13
Nodes (29): Props, WaReportModal, WaReportModalComponent(), findOperator(), formatOperatorFull(), formatOperatorsDisplay(), getAllActiveOperators(), getOperatorOfficialName() (+21 more)
...
Cohesion: 0.19
Nodes (19): AnalyticsDashboardComponent(), getAccumulatedBusData(), getMonthlyToaTrend(), inspectSpreadsheetHeader(), monthlyToaTrendCache, detectHeaderRowAndBuildComposite(), findColumnIndex(), getBusData() (+11 more)
...
### Community 218 - "BusCard.tsx"
Cohesion: 0.10
Nodes (48): BusCard, BusCardComponent(), QueueModal(), QueueModalProps, SyncItem, BulkCopyKmModalOptions, BulkTripModalOptions, getCurrentTheme() (+40 more)
...
Cohesion: 0.15
Nodes (8): BottomNav, BottomNavProps, TEXT_ALERTS, TEXT_DASHBOARD, TEXT_ERRORS, TEXT_FLEET_STATUS, TEXT_MONITORING, TEXT_USER_MANAGEMENT
...
Cohesion: 0.16
Nodes (20): Props, FleetStatusModalProps, Props, UnitDetailModal(), Props, UnitSummaryDashboard, UnitSummaryDashboardComponent(), TEXT_UNIT_DETAIL (+12 more)

### Community 277 - "AnalyticsDashboard.tsx"
Cohesion: 0.19
Nodes (11): AnalyticsDashboard, Props, CompletionStatusCard, Props, KPICard, KPICardComponent(), Props, Props (+3 more)

### Community 278 - "App.tsx"
Cohesion: 0.27
Nodes (9): App(), LoginScreen(), TestComponent(), useUserActivityTracking(), signOut(), sendUserHeartbeat(), showErrorAlert(), checkAndMigrateCache() (+1 more)
...
Cohesion: 0.29
Nodes (12): getTabGid(), numberToColumnName(), formatWholeSheet(), updateBulkBusData(), AuthResult, HeaderMap, MonthlyToaTrendItem, SpreadsheetInspectionResult (+4 more)
...
Cohesion: 0.11
Nodes (28): extractSheetId(), HEADER_KEYWORDS, normalizeString(), tabGidCache, DailyRouteReport, FleetStatusLog, Operator, Role (+20 more)
...
## Knowledge Gaps
- **1844 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+1839 more)
...
- **Why does `react` connect `react` to `plugins`, `ProfileMenuSheet.tsx`, `texts/index.ts`, `Dashboard.tsx`, `DailyToaTrendCard.tsx`, `BusData`, `AnalyticsDashboard.tsx`, `App.tsx`, `ShiftConfirmationAlertBar.tsx`, `BusList.tsx`, `RouteSelectorCard.tsx`, `UserProfileHeader.tsx`, `FleetStatusModal.tsx`, `RoleBadge.tsx`, `useOfflineSync.ts`, `UnitCard.tsx`, `BusCard.tsx`, `AllRouteMonitoringPage.tsx`, `LoginScreen.tsx`, `AccumulationSheet.tsx`, `UserManagementPage.tsx`, `waReportGenerator.ts`, `useMobileBackHandler`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `checkSignedInAsync()` connect `auth.ts` to `App.tsx`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `BusData` connect `BusData` to `routes.ts`, `core.ts`, `useOfflineSync.ts`, `utils/analytics.ts`, `AnalyticsDashboard.tsx`, `BusList.tsx`, `BusCard.tsx`, `mutations.ts`, `FleetStatusModal.tsx`?**
