...
## Corpus Check
- 585 files · ~433,722 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3935 nodes · 5108 edges · 342 communities (311 shown, 31 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6a2f9cac`
...
## Communities (342 total, 31 thin omitted)
...
Cohesion: 0.08
Nodes (55): showAuthExpiredAlert(), showConfirmDialog(), showDeleteQueueConfirm(), showErrorToast(), showInfoToast(), showLogoutConfirm(), showQueueConflictDialog(), showSuccessToast() (+47 more)
...
Cohesion: 0.08
Nodes (39): calculateRegionalTotals(), fetchRegionalMonitoringData(), getRelativeDate(), parseDateParts(), RegionalMonitoringResult, RegionalRouteItem, SUPERVISORS, syncRegionalDailyFromGlobalSheet() (+31 more)
...
Cohesion: 0.11
Nodes (11): BottomNav, BottomNavProps, ShiftConfirmationAlertBar, ShiftConfirmationAlertBarProps, TEXT_ALERTS, TEXT_COMMON, TEXT_ERRORS, TEXT_FLEET_STATUS (+3 more)
...
Cohesion: 0.15
Nodes (18): DailyToaTrendCardComponent(), ToaBarChart(), ToaBarChartProps, ToaExecutiveStats(), ToaExecutiveStatsProps, ToaTrendErrorState(), ToaTrendErrorStateProps, ToaTrendHeader() (+10 more)
...
Cohesion: 0.15
Nodes (24): logActivity(), readPendingActivityLogs(), writePendingActivityLogs(), createRouteWithSheet(), deleteRouteSheet(), fetchRoutesWithSheets(), flushPendingLocalSync(), CrossPeriodSummaryResult (+16 more)
...
Cohesion: 0.08
Nodes (48): AnalyticsDashboard, AnalyticsDashboardComponent(), Props, CompletionStatusCard, Props, DailyToaTrendCard, KPICard, KPICardComponent() (+40 more)
...
Cohesion: 0.06
Nodes (36): BusCard, BusCardComponent(), BusCardStyleOptions, getBusCardStyles(), BusCardSummary(), BusCardSummaryProps, BusInputModal(), BusInputModalProps (+28 more)
...
## Knowledge Gaps
- **2056 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+2051 more)
...
- **Why does `react` connect `react` to `plugins`, `profileMenu/ProfileMenuSheet.tsx`, `keteranganUtils.ts`, `texts/index.ts`, `Dashboard.tsx`, `dailyToaTrend/DailyToaTrendCard.tsx`, `useOfflineSync.ts`, `App.tsx`, `routeSelector/RouteSelectorCard.tsx`, `LoginInfoModal.tsx`, `utils/analytics.ts`, `busList/BusList.tsx`, `waReportGenerator.ts`, `BusInputModal.tsx`, `usePreviousDayOdometer.ts`, `Skeletons.tsx`, `dashboard/QueueModal.tsx`, `monitoring/AllRouteMonitoringPage.tsx`, `login/LoginScreen.tsx`, `accumulation/AccumulationSheet.tsx`, `userManagement/UserManagementPage.tsx`, `FleetStatusModal.tsx`, `pdoReport/RouteOperationalReportCard.tsx`, `historyNavigation.ts`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `isAuthError()` connect `core.ts` to `auth.ts`, `useOfflineSync.ts`?**
