...
## Corpus Check
- 580 files · ~426,903 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3892 nodes · 5052 edges · 342 communities (312 shown, 30 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b68ac0c7`
...
- usePreviousDayOdometer.test.tsx
...
### Community 250 - "UnitSummaryDashboard.tsx"
Cohesion: 0.11
Nodes (21): DailyToaTrendSkeleton(), SkeletonBoxProps, UnitCardSkeleton(), Props, renderStatusBadge(), UnitCard, UnitCardComponent(), Props (+13 more)
...
Cohesion: 0.11
Nodes (29): extractSheetId(), HEADER_KEYWORDS, normalizeString(), tabGidCache, DailyUnitSummary, Operator, Route, RouteSheet (+21 more)
...
Cohesion: 0.14
Nodes (20): calculateRegionalTotals(), fetchRegionalMonitoringData(), getRelativeDate(), parseDateParts(), RegionalMonitoringResult, SUPERVISORS, syncRegionalDailyFromGlobalSheet(), fetchDailyRouteReport() (+12 more)
...
Cohesion: 0.16
Nodes (19): CompletionStatusCard, FormattedNoteText(), getTabGid(), numberToColumnName(), formatWholeSheet(), updateBulkBusData(), AuthResult, MonthlyToaTrendItem (+11 more)
...
Cohesion: 0.24
Nodes (9): App(), LoginScreen(), LoginScreenProps, TestComponent(), useUserActivityTracking(), signOut(), sendUserHeartbeat(), verifyUserProfile() (+1 more)
...
### Community 281 - "busCard/BusCard.tsx"
Cohesion: 0.14
Nodes (12): BusCard, BusCardComponent(), BusCardStyleOptions, getBusCardStyles(), BusCardSummary(), BusCardSummaryProps, BusCardProps, TestHookComponent() (+4 more)
...
Cohesion: 0.21
Nodes (22): getAccumulatedBusData(), getMonthlyToaTrend(), inspectSpreadsheetHeader(), monthlyToaTrendCache, withAuthRetry(), detectHeaderRowAndBuildComposite(), findColumnIndex(), getBusData() (+14 more)
...
Cohesion: 0.11
Nodes (28): AnalyticsDashboard, AnalyticsDashboardComponent(), Props, Props, KPICard, KPICardComponent(), Props, Props (+20 more)
...
Cohesion: 0.20
Nodes (9): AUDIT BUGS — REFACTOR 64: REDESIGN ERGONOMI MODAL INPUT BUS (TOUCH SATSET & ANTI-KEYBOARD VIRTUAL), BUG-64-01: Fragmentasi Kolom Berpasangan Shift Operasional (TOA & KM Terpisah), BUG-64-02: Redundansi Pengetikan 5–6 Digit Angka Odometer KM Setiap Shift, BUG-64-03: Ketiadaan Feedback Selisih Real-Time Odometer & Peringatan Jarak Ekstrem di Form, BUG-64-04: Ketiadaan Kalkulasi Live Breakdown TOA Shift 2 saat Pengisian Total TOA, BUG-64-05: Risiko Tertutupnya Input & Tombol Simpan oleh Mobile Virtual Keyboard, BUG-64-06: Tombol Aksi Sentuh (Touch Target) di Bawah Standar Ergonomi Mobile (<48px), BUG-64-07: Potensi Pelanggaran Kamus Teks Sentral (Hardcoded UI Strings) (+1 more)
...
Cohesion: 0.11
Nodes (23): BusInputModal(), BusInputModalProps, BusInputModalFooter(), BusInputModalFooterProps, BusInputModalHeader(), BusInputModalHeaderProps, BusInputModalNotes(), BusInputModalNotesProps (+15 more)
...
Cohesion: 0.20
Nodes (9): 🎯 Case: Skenario Lapangan, 🔄 Perbandingan Before vs After, REPAIR REPORT — REFACTOR 64: REDESIGN ERGONOMI MODAL INPUT BUS (TOUCH SATSET & ANTI-KEYBOARD VIRTUAL), 📋 Ringkasan Implementasi, Skenario 1: Petugas Pengawas Melakukan Penutupan Shift 1 (TOA S1 + KM Akhir S1), Skenario 2: Petugas Memasukkan KM Awal Shift 2 & Total TOA Malam Hari, Skenario 3: Penggunaan Smartphone Layar 360px dengan Gboard Virtual Keyboard Aktif, Skenario 4: Petugas Mengisi KM Awal S1 Pagi Hari dengan Prefill Otomatis Odometer Kemarin (+1 more)

### Community 342 - "usePreviousDayOdometer.test.tsx"
Cohesion: 0.48
Nodes (5): OdometerTestComponent(), memoryKmCache, usePreviousDayOdometer(), UsePreviousDayOdometerProps, UsePreviousDayOdometerReturn

## Knowledge Gaps
- **2033 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+2028 more)
...
- **Why does `react` connect `react` to `plugins`, `profileMenu/ProfileMenuSheet.tsx`, `mutations.ts`, `texts/index.ts`, `Dashboard.tsx`, `dailyToaTrend/DailyToaTrendCard.tsx`, `useOfflineSync.ts`, `App.tsx`, `busCard/BusCard.tsx`, `routeSelector/RouteSelectorCard.tsx`, `waReport/WaReportModal.tsx`, `LoginInfoModal.tsx`, `utils/analytics.ts`, `busList/BusList.tsx`, `BusInputModal.tsx`, `dashboard/QueueModal.tsx`, `usePreviousDayOdometer.test.tsx`, `monitoring/AllRouteMonitoringPage.tsx`, `login/LoginScreen.tsx`, `accumulation/AccumulationSheet.tsx`, `userManagement/UserManagementPage.tsx`, `FleetStatusModal.tsx`, `UnitSummaryDashboard.tsx`, `pdoReport/RouteOperationalReportCard.tsx`, `historyNavigation.ts`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `Route` connect `core.ts` to `routes.ts`, `utils/analytics.ts`, `allRouteMonitoringService.ts`?**
