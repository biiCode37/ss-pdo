...
## Corpus Check
- 200 files · ~255,318 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2025 nodes · 2622 edges · 182 communities (164 shown, 18 thin omitted)
...
## Communities (182 total, 18 thin omitted)
...
### Community 2 - "cacheUtils.ts"
Cohesion: 0.16
Nodes (20): AccumulationSheet(), MONTH_NAMES_ID, Props, FlatRouteSheet, extractSheetId(), ActivityLog, DailyUnitSummary, Route (+12 more)
...
Cohesion: 0.12
Nodes (17): @aejkatappaja/phantom-ui, gapi-script, lucide-react, dependencies, @aejkatappaja/phantom-ui, gapi-script, lucide-react, react (+9 more)
...
Cohesion: 0.18
Nodes (10): 📱 1. Layout & Tampilan (Mobile-First Priority), 📊 2. Integritas Data (Single Source of Truth - SSOT), 🔐 3. Autentikasi & Sesi Login, 🛠️ 4. Tooling & Paket Manager (Wajib PNPM), 🎨 5. Standar UI/UX & Animasi Fluid (iOS Style), 💬 6. Komunikasi & Workflow Kerja, ⚡ 7. Penggunaan Skill Wajib (Ponytail & Graphify), 📌 8. Kebijakan Commit Git (Hindari Over-Commit) (+2 more)
...
Cohesion: 0.16
Nodes (29): AnalyticsDashboard, BusCardComponent(), BusList, Dashboard(), Props, ProfileMenuSheet(), Props, QueueModal() (+21 more)
...
Cohesion: 0.13
Nodes (18): AnalyticsDashboardComponent(), CompletionStatusCard, Props, FormattedNoteText(), KPICard, Props, Props, ShiftComparisonCard (+10 more)
...
### Community 124 - "react"
Cohesion: 0.22
Nodes (5): react, BottomNav, BottomNavProps, SwipeableContainer(), SwipeableContainerProps

### Community 125 - "App.tsx"
Cohesion: 0.19
Nodes (18): App(), LegalModals(), LegalModalsProps, LegalModalType, LoginScreen(), Props, checkSignedInAsync(), ensureValidToken() (+10 more)
...
Cohesion: 0.18
Nodes (17): Props, renderStatusBadge(), UnitCard, UnitCardComponent(), Props, UnitDetailModal(), UnitSummaryDashboardComponent(), slugifyUnitId() (+9 more)
...
### Community 171 - "BusCard.tsx"
Cohesion: 0.20
Nodes (18): Props, BusCard, Props, BusListComponent(), Props, Props, SyncItem, BusData (+10 more)
...
Cohesion: 0.25
Nodes (15): getAccumulatedBusData(), getMonthlyToaTrend(), inspectSpreadsheetHeader(), monthlyToaTrendCache, withAuthRetry(), detectHeaderRowAndBuildComposite(), findColumnIndex(), getBusData() (+7 more)

### Community 177 - "mutations.ts"
Cohesion: 0.29
Nodes (13): getTabGid(), numberToColumnName(), formatWholeSheet(), updateBulkBusData(), updateBusData(), AuthResult, MonthlyToaTrendItem, SpreadsheetInspectionResult (+5 more)

### Community 178 - "RouteSelectorCard.tsx"
Cohesion: 0.28
Nodes (12): flattenRoutes(), MONTH_NAMES_ID, Props, RouteSelectorCard, RouteSelectorCardComponent(), createRouteWithSheet(), deleteRouteSheet(), fetchRoutesWithSheets() (+4 more)

### Community 179 - "useOfflineSync.ts"
Cohesion: 0.25
Nodes (10): TestHookComponent(), detectCollision(), readQueueFromStorage(), RETRY_DELAYS, useOfflineSync(), UseOfflineSyncOptions, writeQueueToStorage(), getBusRowData() (+2 more)

### Community 180 - "routeService.ts"
Cohesion: 0.29
Nodes (8): TestComponent(), useUserActivityTracking(), CrossPeriodSummaryResult, sendUserHeartbeat(), localStorageMock, upsertUserProfile(), isSupabaseConfigured, supabase

### Community 181 - "DailyToaTrendCard.tsx"
Cohesion: 0.21
Nodes (9): DailyToaTrendCard, DailyToaTrendCardComponent(), parseSelectedDay(), Props, BusCardSkeleton(), DailyToaTrendSkeleton(), SkeletonBoxProps, UnitCardSkeleton() (+1 more)

## Knowledge Gaps
- **1193 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+1188 more)
...
- **Why does `react` connect `react` to `cacheUtils.ts`, `plugins`, `BusCard.tsx`, `RouteSelectorCard.tsx`, `useOfflineSync.ts`, `Dashboard.tsx`, `DailyToaTrendCard.tsx`, `utils/analytics.ts`, `googleSheets.ts`, `routeService.ts`, `App.tsx`?**
