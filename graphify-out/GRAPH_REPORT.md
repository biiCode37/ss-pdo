...
## Corpus Check
- 580 files · ~426,307 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3890 nodes · 5050 edges · 344 communities (314 shown, 30 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b90fcfea`
...
## Communities (344 total, 30 thin omitted)
...
Cohesion: 0.08
Nodes (54): showAuthExpiredAlert(), showConfirmDialog(), showDeleteQueueConfirm(), showErrorToast(), showInfoToast(), showLogoutConfirm(), showQueueConflictDialog(), showSuccessToast() (+46 more)
...
### Community 254 - "TEXT_DASHBOARD"
Cohesion: 0.19
Nodes (14): AddRouteModal(), AddRouteModalProps, RouteSelectorSheet(), RouteSelectorSheetProps, TEXT_DASHBOARD, useMobileBackHandler(), UseMobileBackHandlerOptions, BackNavigationEntry (+6 more)
...
Cohesion: 0.14
Nodes (24): extractSheetId(), Operator, Route, RouteSheet, BusNote, extractMonthYearLabel(), parseNumericTab(), resolveRouteContext() (+16 more)
...
Cohesion: 0.13
Nodes (8): BottomNav, BottomNavProps, TEXT_ALERTS, TEXT_COMMON, TEXT_ERRORS, TEXT_FLEET_STATUS, TEXT_MONITORING, TEXT_USER_MANAGEMENT
...
Cohesion: 0.12
Nodes (30): logActivity(), readPendingActivityLogs(), writePendingActivityLogs(), createRouteWithSheet(), deleteRouteSheet(), fetchRoutesWithSheets(), getCrossPeriodAccumulation(), flushPendingLocalSync() (+22 more)
...
Cohesion: 0.11
Nodes (40): SyncItem, getAccumulatedBusData(), getMonthlyToaTrend(), inspectSpreadsheetHeader(), monthlyToaTrendCache, withAuthRetry(), detectHeaderRowAndBuildComposite(), findColumnIndex() (+32 more)
...
### Community 307 - "parseIndonesianNumber"
Cohesion: 0.14
Nodes (20): AnalyticsDashboard, AnalyticsDashboardComponent(), Props, Props, KPICard, KPICardComponent(), Props, Props (+12 more)
...
Cohesion: 0.22
Nodes (8): AUDIT BUGS — REFACTOR 64: REDESIGN ERGONOMI MODAL INPUT BUS (TOUCH SATSET & ANTI-KEYBOARD VIRTUAL), BUG-64-01: Fragmentasi Kolom Berpasangan Shift Operasional (TOA & KM Terpisah), BUG-64-02: Redundansi Pengetikan 5–6 Digit Angka Odometer KM Setiap Shift, BUG-64-03: Ketiadaan Feedback Selisih Real-Time Odometer & Peringatan Jarak Ekstrem di Form, BUG-64-04: Ketiadaan Kalkulasi Live Breakdown TOA Shift 2 saat Pengisian Total TOA, BUG-64-05: Risiko Tertutupnya Input & Tombol Simpan oleh Mobile Virtual Keyboard, BUG-64-06: Tombol Aksi Sentuh (Touch Target) di Bawah Standar Ergonomi Mobile (<48px), BUG-64-07: Potensi Pelanggaran Kamus Teks Sentral (Hardcoded UI Strings)
...
### Community 338 - "react"
Cohesion: 0.13
Nodes (11): react, BusListShiftLockBannerProps, ShiftConfirmationAlertBar, ShiftConfirmationAlertBarProps, SwipeableContainer(), SwipeableContainerProps, RoleBadge(), RoleBadgeProps (+3 more)

### Community 340 - "REPAIR REPORT — REFACTOR 64: REDESIGN ERGONOMI MODAL INPUT BUS (TOUCH SATSET & ANTI-KEYBOARD VIRTUAL)"
Cohesion: 0.22
Nodes (8): 🎯 Case: Skenario Lapangan, 🔄 Perbandingan Before vs After, REPAIR REPORT — REFACTOR 64: REDESIGN ERGONOMI MODAL INPUT BUS (TOUCH SATSET & ANTI-KEYBOARD VIRTUAL), 📋 Ringkasan Implementasi, Skenario 1: Petugas Pengawas Melakukan Penutupan Shift 1 (TOA S1 + KM Akhir S1), Skenario 2: Petugas Memasukkan KM Awal Shift 2 & Total TOA Malam Hari, Skenario 3: Penggunaan Smartphone Layar 360px dengan Gboard Virtual Keyboard Aktif, 🛡️ Status Verifikasi & Quality Gates

### Community 341 - "Skeletons.tsx"
Cohesion: 0.25
...
### Community 343 - "LoginScreen.test.tsx"
Cohesion: 0.40
Nodes (4): mockSignIn, mockSignOut, mockUpsertUserProfile, mockVerifyUserProfile

## Knowledge Gaps
- **2031 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+2026 more)
...
- **Why does `react` connect `react` to `plugins`, `profileMenu/ProfileMenuSheet.tsx`, `keteranganUtils.ts`, `texts/index.ts`, `Dashboard.tsx`, `dailyToaTrend/DailyToaTrendCard.tsx`, `useOfflineSync.ts`, `App.tsx`, `busCard/BusCard.tsx`, `routeSelector/RouteSelectorCard.tsx`, `waReport/WaReportModal.tsx`, `LoginInfoModal.tsx`, `parseIndonesianNumber`, `busList/BusList.tsx`, `BusInputModal.tsx`, `profileMenu/UserProfileHeader.tsx`, `dashboard/QueueModal.tsx`, `Skeletons.tsx`, `usePreviousDayOdometer.test.tsx`, `LoginScreen.test.tsx`, `monitoring/AllRouteMonitoringPage.tsx`, `login/LoginScreen.tsx`, `accumulation/AccumulationSheet.tsx`, `userManagement/UserManagementPage.tsx`, `FleetStatusModal.tsx`, `BusData`, `pdoReport/RouteOperationalReportCard.tsx`, `TEXT_DASHBOARD`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `Route` connect `utils/analytics.ts` to `routes.ts`, `allRouteMonitoringService.ts`?**
