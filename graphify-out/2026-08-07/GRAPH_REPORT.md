...
7. `parseIndonesianNumber()` - 15 edges
...
Cohesion: 0.11
Nodes (26): AccumulationSheet(), MONTH_NAMES_ID, Props, ProfileMenuSheet(), Props, FlatRouteSheet, flattenRoutes(), MONTH_NAMES_ID (+18 more)
