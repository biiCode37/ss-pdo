...
## Corpus Check
- 576 files · ~422,835 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3865 nodes · 5022 edges · 340 communities (310 shown, 30 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `27f5bc2d`
...
## Communities (340 total, 30 thin omitted)
...
Cohesion: 0.12
Nodes (17): FleetStatusFooter(), FleetStatusFooterProps, FleetStatusGrid(), FleetStatusGridProps, FleetStatusHeader(), FleetStatusHeaderProps, FleetStatusModal, FleetStatusModalComponent() (+9 more)
...
Cohesion: 0.13
Nodes (24): Props, renderStatusBadge(), UnitCard, UnitCardComponent(), Props, UnitDetailModal(), Props, UnitSummaryDashboard (+16 more)
...
Cohesion: 0.14
Nodes (23): Operator, Route, RouteSheet, SyncQueueBackup, extractMonthYearLabel(), parseNumericTab(), resolveRouteContext(), RouteContext (+15 more)
...
Cohesion: 0.16
Nodes (23): TestHookComponent(), detectCollision(), readQueueFromStorage(), SyncItem, useOfflineSync(), UseOfflineSyncOptions, writeQueueToStorage(), getBusRowData() (+15 more)

### Community 277 - "App.tsx"
Cohesion: 0.19
Nodes (13): App(), LoginScreen(), TestComponent(), useUserActivityTracking(), signOut(), AuthResult, sendUserHeartbeat(), tryOfflineProfileFallback() (+5 more)
...
Cohesion: 0.14
Nodes (25): logActivity(), readPendingActivityLogs(), writePendingActivityLogs(), createRouteWithSheet(), deleteRouteSheet(), fetchRoutesWithSheets(), flushPendingLocalSync(), addUserProfile() (+17 more)
...
Cohesion: 0.15
Nodes (27): getAccumulatedBusData(), getMonthlyToaTrend(), inspectSpreadsheetHeader(), monthlyToaTrendCache, withAuthRetry(), detectHeaderRowAndBuildComposite(), extractSheetId(), findColumnIndex() (+19 more)
...
### Community 321 - "1. THE THREE DIALS (Core Configuration)"
Cohesion: 0.50
...
## Knowledge Gaps
- **2017 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+2012 more)
...
- **Why does `react` connect `react` to `plugins`, `profileMenu/ProfileMenuSheet.tsx`, `keteranganUtils.ts`, `texts/index.ts`, `Dashboard.tsx`, `dailyToaTrend/DailyToaTrendCard.tsx`, `mutations.ts`, `App.tsx`, `busCard/BusCard.tsx`, `routeSelector/RouteSelectorCard.tsx`, `waReport/WaReportModal.tsx`, `LoginInfoModal.tsx`, `utils/analytics.ts`, `busList/BusList.tsx`, `BusInputModal.tsx`, `profileMenu/UserProfileHeader.tsx`, `dashboard/QueueModal.tsx`, `monitoring/AllRouteMonitoringPage.tsx`, `login/LoginScreen.tsx`, `accumulation/AccumulationSheet.tsx`, `userManagement/UserManagementPage.tsx`, `FleetStatusModal.tsx`, `BusData`, `pdoReport/RouteOperationalReportCard.tsx`, `historyNavigation.ts`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `isAuthError()` connect `mutations.ts` to `auth.ts`, `core.ts`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `BusData` connect `BusData` to `utils/analytics.ts`, `mutations.ts`, `FleetStatusModal.tsx`, `routes.ts`, `core.ts`?**
