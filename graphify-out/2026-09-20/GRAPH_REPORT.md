...
## Corpus Check
- 580 files · ~427,248 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3894 nodes · 5054 edges · 343 communities (313 shown, 30 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b56feade`
...
## Communities (343 total, 30 thin omitted)
...
Cohesion: 0.13
Nodes (23): extractSheetId(), Operator, Route, RouteSheet, extractMonthYearLabel(), parseNumericTab(), RouteContext, checkAndMigrateCache() (+15 more)
...
Cohesion: 0.16
Nodes (20): calculateRegionalTotals(), fetchRegionalMonitoringData(), getRelativeDate(), parseDateParts(), RegionalMonitoringResult, RegionalRouteItem, SUPERVISORS, syncRegionalDailyFromGlobalSheet() (+12 more)
...
Cohesion: 0.19
Nodes (19): getTabGid(), numberToColumnName(), formatWholeSheet(), updateBulkBusData(), updateBusData(), AuthResult, MonthlyToaTrendItem, SpreadsheetInspectionResult (+11 more)
...
Cohesion: 0.13
Nodes (11): BottomNav, BottomNavProps, AddRouteModalProps, RouteSelectorSheetProps, TEXT_ALERTS, TEXT_COMMON, TEXT_DASHBOARD, TEXT_ERRORS (+3 more)
...
Cohesion: 0.29
Nodes (7): App(), TestComponent(), useUserActivityTracking(), sendUserHeartbeat(), verifyUserProfile(), showErrorAlert(), formatUserError()
...
Cohesion: 0.16
Nodes (27): getAccumulatedBusData(), getMonthlyToaTrend(), inspectSpreadsheetHeader(), monthlyToaTrendCache, withAuthRetry(), detectHeaderRowAndBuildComposite(), findColumnIndex(), getBusData() (+19 more)
...
Cohesion: 0.12
Nodes (24): AnalyticsDashboard, AnalyticsDashboardComponent(), Props, CompletionStatusCard, Props, FormattedNoteText(), KPICard, KPICardComponent() (+16 more)
...
### Community 338 - "react"
Cohesion: 0.18
Nodes (10): react, QueueModal(), QueueModalProps, SwipeableContainer(), SwipeableContainerProps, RoleBadge(), RoleBadgeProps, ViewportTestComponent() (+2 more)
...
## Knowledge Gaps
- **2035 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+2030 more)
...
- **Why does `react` connect `react` to `plugins`, `profileMenu/ProfileMenuSheet.tsx`, `texts/index.ts`, `Dashboard.tsx`, `dailyToaTrend/DailyToaTrendCard.tsx`, `useOfflineSync.ts`, `App.tsx`, `busCard/BusCard.tsx`, `routeSelector/RouteSelectorCard.tsx`, `waReport/WaReportModal.tsx`, `LoginInfoModal.tsx`, `utils/analytics.ts`, `busList/BusList.tsx`, `BusInputModal.tsx`, `profileMenu/UserProfileHeader.tsx`, `ShiftConfirmationAlertBar.tsx`, `usePreviousDayOdometer.test.tsx`, `monitoring/AllRouteMonitoringPage.tsx`, `login/LoginScreen.tsx`, `accumulation/AccumulationSheet.tsx`, `userManagement/UserManagementPage.tsx`, `FleetStatusModal.tsx`, `BusData`, `pdoReport/RouteOperationalReportCard.tsx`, `historyNavigation.ts`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `Route` connect `types/supabase.ts` to `utils/analytics.ts`, `routes.ts`, `allRouteMonitoringService.ts`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **What connects `crypto`, `http`, `fs` to the rest of the system?**
  _2035 weakly-connected nodes found - possible documentation gaps or missing edges._
