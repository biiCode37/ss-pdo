# Graph Report - SS_PDO  (2026-09-12)

## Corpus Check
- 364 files · ~366,796 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3057 nodes · 4158 edges · 266 communities (239 shown, 27 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f1c85ea3`
...
1. `react` - 51 edges
2. `BusData` - 33 edges
3. `Dashboard()` - 30 edges
4. `parseIndonesianNumber()` - 28 edges
5. `Writing Skills` - 23 edges
6. `TEXT_DASHBOARD` - 21 edges
7. `logActivity()` - 21 edges
8. `==========================================` - 21 edges
9. `compilerOptions` - 19 edges
10. `BusCardComponent()` - 18 edges
...
### Community 6 - "alertUtils.ts"
Cohesion: 0.17
Nodes (24): Dashboard(), ProfileMenuSheet(), Props, QueueModal(), Props, RouteOperationalReportCard, RouteOperationalReportCardComponent(), upsertDailyRouteReport() (+16 more)
...
Cohesion: 0.21
Nodes (14): Props, UnitDetailModal(), Props, UnitSummaryDashboard, UnitSummaryDashboardComponent(), TEXT_UNIT_DETAIL, calculateUnitMetrics(), calculateUnitMetricsFromRow() (+6 more)
...
Cohesion: 0.13
Nodes (20): AnalyticsDashboard, AnalyticsDashboardComponent(), CompletionStatusCard, Props, DailyToaTrendCard, KPICard, KPICardComponent(), Props (+12 more)
...
### Community 125 - "types/supabase.ts"
Cohesion: 0.18
Nodes (15): backupSyncQueue(), readPendingActivityLogs(), writePendingActivityLogs(), deleteRouteSheet(), fetchRoutesWithSheets(), flushPendingLocalSync(), CrossPeriodSummaryResult, isSupabaseConfigured (+7 more)
...
### Community 206 - "Dashboard.tsx"
Cohesion: 0.09
Nodes (27): react, AccumulationSheet(), Props, DailyToaTrendCardComponent(), parseSelectedDay(), Props, Props, UserManagementPage (+19 more)
...
Cohesion: 0.14
Nodes (21): RoleBadge(), RoleBadgeProps, SkeletonBox(), FilterTab, UserManagementPage(), UserManagementPageProps, TestComponent(), useUserActivityTracking() (+13 more)
...
Cohesion: 0.16
Nodes (8): BottomNav, BottomNavProps, TEXT_ALERTS, TEXT_DASHBOARD, TEXT_ERRORS, TEXT_FLEET_STATUS, TEXT_PDO_FORM, TEXT_USER_MANAGEMENT
...
### Community 240 - "waReportGenerator.ts"
Cohesion: 0.23
...
### Community 247 - "BusCard.tsx"
Cohesion: 0.10
Nodes (34): BusCard, BusCardComponent(), FormattedNoteText(), Props, renderStatusBadge(), UnitCard, UnitCardComponent(), BulkCopyKmModalOptions (+26 more)
...
Cohesion: 0.06
Nodes (69): App(), RouteSelectorCardComponent(), getAccumulatedBusData(), getMonthlyToaTrend(), inspectSpreadsheetHeader(), monthlyToaTrendCache, checkSignedInAsync(), ensureValidToken() (+61 more)

### Community 251 - "BusData"
Cohesion: 0.17
Nodes (19): Props, Props, Props, FleetStatusModalProps, QueueModalProps, TestHookComponent(), detectCollision(), readQueueFromStorage() (+11 more)
...
Cohesion: 0.14
Nodes (18): AddRouteModal(), AddRouteModalProps, RouteSelectorSheet(), RouteSelectorSheetProps, INDO_DAYS, INDO_MONTHS_SHORT, Props, RouteSelectorCard (+10 more)

### Community 255 - "AllRouteMonitoringPage.tsx"
Cohesion: 0.15
Nodes (13): AllRouteMonitoringPage, formatDecimal(), formatNumber(), Props, RouteCardItem(), RouteCardItemProps, SUPERVISOR_TABS, mockData (+5 more)
...
### Community 265 - "1. THE THREE DIALS (Core Configuration)"
Cohesion: 0.50
Nodes (4): 1.A Dial Inference (design read → dial values), 1.B Use-Case Presets, 1.C How the Dials Drive Output, 1. THE THREE DIALS (Core Configuration)

## Knowledge Gaps
- **1734 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+1729 more)
...
- **Why does `react` connect `Dashboard.tsx` to `BusList.tsx`, `texts/index.ts`, `plugins`, `alertUtils.ts`, `UserManagementPage.tsx`, `waReportGenerator.ts`, `LoginScreen.tsx`, `googleSheets.ts`, `BusCard.tsx`, `utils/analytics.ts`, `core.ts`, `BusData`, `RouteSelectorCard.tsx`, `AllRouteMonitoringPage.tsx`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `logActivity()` connect `UserManagementPage.tsx` to `core.ts`, `BusData`, `types/supabase.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `BusData` connect `BusData` to `BusList.tsx`, `Dashboard.tsx`, `googleSheets.ts`, `BusCard.tsx`, `utils/analytics.ts`, `core.ts`, `types/supabase.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
