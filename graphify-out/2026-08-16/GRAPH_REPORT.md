...
## Corpus Check
- 167 files · ~185,957 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1700 nodes · 2143 edges · 153 communities (134 shown, 19 thin omitted)
...
Cohesion: 0.06
Nodes (65): App(), AccumulationSheet(), MONTH_NAMES_ID, Props, LoginScreen(), Props, FlatRouteSheet, flattenRoutes() (+57 more)
...
### Community 116 - "parseIndonesianNumber"
Cohesion: 0.16
Nodes (20): FormattedNoteText(), Props, renderStatusBadge(), UnitCard, UnitCardComponent(), UnitDetailModal(), Props, UnitSummaryDashboard() (+12 more)
...
### Community 118 - "alertUtils.ts"
Cohesion: 0.19
Nodes (24): BusCard, BusList(), ProfileMenuSheet(), Props, BulkCopyKmModalOptions, CATEGORY_META, getCurrentTheme(), pdoSwal (+16 more)
...
### Community 121 - "react"
Cohesion: 0.15
Nodes (11): react, DailyToaTrendCard(), parseSelectedDay(), Props, BusCardSkeleton(), DailyToaTrendSkeleton(), SkeletonBoxProps, UnitCardSkeleton() (+3 more)
...
### Community 124 - "useOfflineSync.ts"
Cohesion: 0.20
Nodes (17): Props, Props, Props, detectCollision(), isAuthError(), readQueueFromStorage(), RETRY_DELAYS, SyncItem (+9 more)

### Community 125 - "Dashboard.tsx"
Cohesion: 0.30
Nodes (11): BusCardComponent(), Dashboard(), Props, isNetworkError(), extractSheetId(), reauthenticateSession(), getCrossPeriodAccumulation(), showErrorToast() (+3 more)
...
## Knowledge Gaps
- **1001 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+996 more)
...
- **Why does `react` connect `react` to `googleSheets.ts`, `plugins`, `parseIndonesianNumber`, `alertUtils.ts`, `useOfflineSync.ts`, `Dashboard.tsx`?**
