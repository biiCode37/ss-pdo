# Graph Report - SS_PDO  (2026-09-11)

## Corpus Check
- 353 files · ~360,902 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2992 nodes · 4089 edges · 251 communities (224 shown, 27 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b827dba7`
...
### Community 6 - "BusList.tsx"
Cohesion: 0.17
Nodes (14): BusList, BusListComponent(), BrushMode, FleetStatusModal, FleetStatusModalComponent(), FormattedNoteText(), showBulkCopyKmModal(), showBulkTripModal() (+6 more)
...
Cohesion: 0.13
Nodes (24): BusCard, FleetStatusModalProps, Props, renderStatusBadge(), UnitCard, UnitCardComponent(), Props, UnitDetailModal() (+16 more)
...
Cohesion: 0.11
Nodes (24): AnalyticsDashboard, AnalyticsDashboardComponent(), Props, CompletionStatusCard, Props, DailyToaTrendCard, DailyToaTrendCardComponent(), parseSelectedDay() (+16 more)
...
Cohesion: 0.14
Nodes (29): BusCardComponent(), TestHookComponent(), detectCollision(), readQueueFromStorage(), useOfflineSync(), writeQueueToStorage(), getBusRowData(), updateBusData() (+21 more)

### Community 125 - "Dashboard.tsx"
Cohesion: 0.09
Nodes (25): react, BottomNav, BottomNavProps, Props, UserManagementPage, ShiftConfirmationAlertBar, ShiftConfirmationAlertBarProps, BusCardSkeleton() (+17 more)
...
### Community 206 - "texts/index.ts"
Cohesion: 0.11
Nodes (19): Props, INDO_DAYS, INDO_MONTHS_SHORT, Props, RouteSelectorCard, RouteSelectorCardComponent(), TEXT_ALERTS, TEXT_COMMON (+11 more)
...
### Community 218 - "types/supabase.ts"
Cohesion: 0.07
Nodes (50): RoleBadge(), RoleBadgeProps, Props, RouteOperationalReportCard, RouteOperationalReportCardComponent(), FilterTab, UserManagementPage(), UserManagementPageProps (+42 more)
...
### Community 225 - "useMobileBackHandler"
Cohesion: 0.20
...
Cohesion: 0.09
Nodes (35): AllRouteMonitoringPage, formatDecimal(), formatNumber(), Props, RouteCardItem(), RouteCardItemProps, SUPERVISOR_TABS, mockData (+27 more)
...
Cohesion: 0.10
Nodes (25): App(), LegalModals(), LegalModalsProps, LegalModalType, LoginFeatureCards(), LoginFooter(), LoginFooterProps, LoginHeroCard() (+17 more)
...
Cohesion: 0.16
Nodes (28): Props, Props, Dashboard(), ProfileMenuSheet(), Props, QueueModal(), QueueModalProps, SyncItem (+20 more)
...
Cohesion: 0.07
Nodes (65): AccumulationSheet(), getAccumulatedBusData(), getMonthlyToaTrend(), inspectSpreadsheetHeader(), monthlyToaTrendCache, checkSignedInAsync(), ensureValidToken(), fetchGoogleUserProfile() (+57 more)
...
## Knowledge Gaps
- **1702 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+1697 more)
...
- **Why does `react` connect `Dashboard.tsx` to `useMobileBackHandler`, `plugins`, `BusList.tsx`, `texts/index.ts`, `AllRouteMonitoringPage.tsx`, `LoginScreen.tsx`, `BusData`, `alertUtils.ts`, `utils/analytics.ts`, `types/supabase.ts`, `BusCard.tsx`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `BusData` connect `BusData` to `BusList.tsx`, `types/supabase.ts`, `alertUtils.ts`, `utils/analytics.ts`, `core.ts`, `BusCard.tsx`, `Dashboard.tsx`?**
