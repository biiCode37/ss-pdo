...
## Corpus Check
- 368 files · ~369,718 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3103 nodes · 4201 edges · 269 communities (242 shown, 27 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1671ee20`
...
### Community 6 - "App.tsx"
Cohesion: 0.36
Nodes (8): App(), LoginScreen(), ProfileMenuSheet(), Props, signOut(), verifyUserProfile(), showErrorAlert(), formatUserError()
...
Cohesion: 0.15
Nodes (19): BusCard, FleetStatusModalProps, Props, UnitDetailModal(), Props, UnitSummaryDashboardComponent(), UseOfflineSyncOptions, BusData (+11 more)
...
Cohesion: 0.09
Nodes (33): AnalyticsDashboard, AnalyticsDashboardComponent(), Props, CompletionStatusCard, Props, DailyToaTrendCard, DailyToaTrendCardComponent(), parseSelectedDay() (+25 more)
...
Cohesion: 0.19
Nodes (11): RoleBadge(), RoleBadgeProps, SkeletonBox(), FilterTab, UserManagementPageProps, FleetStatusLog, Operator, Role (+3 more)
...
Cohesion: 0.08
Nodes (30): react, AccumulationSheet(), Props, BottomNav, BottomNavProps, Props, UserManagementPage, ShiftConfirmationAlertBar (+22 more)
...
Cohesion: 0.23
Nodes (8): ROLE_DISPLAY_CONFIG, UserProfileHeader, UserProfileHeaderComponent(), UserProfileHeaderProps, TEXT_USER_MANAGEMENT, getStoredUserRole(), UserRole, VALID_ROLES
...
Cohesion: 0.06
Nodes (56): AllRouteMonitoringPage, formatDecimal(), formatNumber(), Props, RouteCardItem(), RouteCardItemProps, SUPERVISOR_TABS, mockData (+48 more)
...
Cohesion: 0.10
Nodes (20): LegalModals(), LegalModalsProps, LegalModalType, LoginFeatureCards(), LoginFooter(), LoginFooterProps, LoginHeroCard(), LoginHeroCardProps (+12 more)
...
Cohesion: 0.12
Nodes (42): BusCardComponent(), Props, Props, Dashboard(), QueueModal(), QueueModalProps, SyncItem, HeaderMap (+34 more)
...
Cohesion: 0.07
Nodes (63): RouteSelectorCardComponent(), getAccumulatedBusData(), getMonthlyToaTrend(), inspectSpreadsheetHeader(), monthlyToaTrendCache, withAuthRetry(), detectHeaderRowAndBuildComposite(), extractSheetId() (+55 more)

### Community 251 - "useOfflineSync.ts"
Cohesion: 0.38
Nodes (8): TestHookComponent(), detectCollision(), readQueueFromStorage(), useOfflineSync(), writeQueueToStorage(), getBusRowData(), updateBusData(), backupSyncQueue()
...
Cohesion: 0.36
Nodes (7): BackNavigationEntry, handlePopState(), initHistoryNavigation(), isRunningStandalone(), navigationStack, pushBackNavigation(), removeBackNavigation()
...
### Community 263 - "auth.ts"
Cohesion: 0.30
Nodes (13): checkSignedInAsync(), ensureValidToken(), fetchGoogleUserProfile(), getGapi(), getGoogleCreds(), hasGoogleCreds(), initGoogleApi(), reauthenticateSession() (+5 more)
...
## Knowledge Gaps
- **1758 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+1753 more)
...
- **Why does `react` connect `Dashboard.tsx` to `BusList.tsx`, `UserProfileHeader.tsx`, `plugins`, `App.tsx`, `routeService.ts`, `AllRouteMonitoringPage.tsx`, `texts/index.ts`, `BusData`, `alertUtils.ts`, `utils/analytics.ts`, `useOfflineSync.ts`, `types/supabase.ts`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `logActivity()` connect `users.ts` to `core.ts`, `useOfflineSync.ts`, `App.tsx`, `auth.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `BusData` connect `BusData` to `BusList.tsx`, `Dashboard.tsx`, `alertUtils.ts`, `utils/analytics.ts`, `core.ts`, `useOfflineSync.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
